...
static char DEFAULT_DTB_FILE[100]	="rk-kernel.dtb";
static int count=0;
/*
...
static struct resource_file *get_default_dtb(void)
{
	...
	struct list_head *node;
	int num = 0;
	char menu_switch[100],data_buf[100];
	volatile unsigned int *menusiwtch_mem,*mem;

	strcpy(menu_switch, "mmc read 8200010 1810 1");
	run_command(menu_switch, 0);
	menusiwtch_mem= (volatile unsigned int *)0x08200010;
	printf("menu status: %d \n",*menusiwtch_mem);

	if((!count ) && (!IS_ENABLED(CONFIG_CONSOLE_DISABLE_CLI) && ctrlc()))
			run_command("menu", 0);

	if(*menusiwtch_mem!=0){
		strcpy(data_buf, "mmc read 8200000 1800 1");
		run_command(data_buf, 0);
		mem = (volatile unsigned int *)0x08200000;
		printf("ID: %d \n\r", *mem);
		switch(*mem){
			case 0:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lkd3588-f0.dtb");
				break;
			case 1:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lkd3588-f1.dtb");
				break;
			case 2:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lkd3588-f2.dtb");
				break;
			case 3:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lkd3588-f3.dtb");
				break;
			case 4:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lkd3588-f4.dtb");
				break;
			case 5:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lkd3588-t0.dtb");
				break;
			case 6:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lkd3588-t1.dtb");
				break;
			case 7:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lkd3588-p0.dtb");
				break;
			case 8:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lpa3588-f0.dtb");
				break;
			case 9:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lpa3588-f1.dtb");
				break;
			case 10:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lpa3588-f2.dtb");
				break;
			case 11:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lpa3588-f3.dtb");
				break;
			case 12:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lpa3588-f4.dtb");
				break;
			case 13:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lpa3588-t0.dtb");
				break;
			case 14:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lpb3588-f0.dtb");
				break;
			case 15:
				strcpy(DEFAULT_DTB_FILE,"rk3588-neardi-linux-lpb3588-t0.dtb");
				break;
			default:
				strcpy(DEFAULT_DTB_FILE,"rk-kernel.dtb");
				break;
			}
		}
