...
UsbPortPowerEnable (void)
{
  ...
  MmioWrite32(GPIO1_BASE + GPIO_SWPORT_DR_H,  (0x0400UL << 16) | 0x0400); // 31:16, write mask bits; 0:15 bits GPIO values.
  MmioWrite32(GPIO1_BASE + GPIO_SWPORT_DDR_H, (0x0400UL << 16) | 0x0400); // 31:16 direction values.

  /* enable usb otg0 vbus supply */
//  MmioWrite32(GPIO1_BASE + GPIO_SWPORT_DR_H,  (0x4000UL << 16) | 0x4000);
//  MmioWrite32(GPIO1_BASE + GPIO_SWPORT_DDR_H, (0x4000UL << 16) | 0x4000);
}
