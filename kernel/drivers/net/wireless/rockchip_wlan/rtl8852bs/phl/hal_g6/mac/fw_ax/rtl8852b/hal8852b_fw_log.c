...
struct mac_fw_msg fw_log_8852b[] = {
	...
	{MSG_8852B_PKTOFLD_RSP_RTY, "pktofld rsp retry\n"},
	{MSG_8852B_PKTOFLD_RSP_FAIL, "pktofld rsp first fail (%d)\n"},
	{MSG_8852B_PKTOFLD_ADD_NODE_NULL, "pktofld add fail (node null) and return\n"},
	{MSG_8852B_PKTOFLD_ADD_CONT_NULL, "pktofld add fail (content null) and return\n"},
	{MSG_8852B_PKTOFLD_RET, "pktofld hdl return %d\n"},
