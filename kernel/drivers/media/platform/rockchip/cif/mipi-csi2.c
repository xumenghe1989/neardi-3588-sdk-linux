...
int jaguar1_get_mipinum(void)
{
	
	//printk(".......dysun %s %d %d\n",__func__,__LINE__,get_mipinum);
    return get_mipinum;
}
EXPORT_SYMBOL_GPL(jaguar1_get_mipinum);
...
static int csi2_s_stream(struct v4l2_subdev *sd, int enable)
{
	...
	char mipi0_csi2[] = "mipi0-csi2"; 
	char mipi1_csi2[] = "mipi1-csi2";
    ...
    printk(KERN_INFO "......dtsun jaguar1_get_mipinum\n");
	
	if (strcmp(mipi0_csi2, csi2->dev_name) == 0)
		get_mipinum=0;
	if (strcmp(mipi1_csi2, csi2->dev_name) == 0)
		get_mipinum=1;
	
	printk(".......dysun %s %d %d\n",__func__,__LINE__,get_mipinum);
	
	printk(".......dysun %s %d %s\n",__func__,__LINE__,csi2->dev_name);
