...
static __net_init int sysctl_core_net_init(struct net *net)
{
	...
	/**
	 * here, change the default value: /proc/sys/net/core/rmem_default = 20971520, so
	 * that it'll not lost packets on UDP when doing ping.
	 */
	sysctl_rmem_default = 20971520;
